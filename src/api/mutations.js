...
export const createBook = /* GraphQL */ `
  mutation CreateBook($input: CreateBookInput!, $condition: ModelBookConditionInput) {
...
export const updateBook = /* GraphQL */ `
  mutation UpdateBook($input: UpdateBookInput!, $condition: ModelBookConditionInput) {
...
export const deleteBook = /* GraphQL */ `
  mutation DeleteBook($input: DeleteBookInput!, $condition: ModelBookConditionInput) {
